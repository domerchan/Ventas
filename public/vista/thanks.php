...
<section>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-8">
          <div class="alert alert-success">Tu mensaje se ha enviado correctamente. <button type="button" class="close"
              data-dismiss="alert">×
            </button></div>
          <p>Te contestaremos en breve. </p>
          <p>Si tienes una incidencia con tu pedido puedes contactarnos por teléfono: </p>
