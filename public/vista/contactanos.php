            ...
            <div class="contact-form">
                <form action="agregaPregunta.php" method="POST">
                    ...
                    <p class="block_contact">
                        ...
                        <input type="text" name="asunto" id="asunto" placeholder="Ingrese el asunto" required="" />
                    </p>
                    ...
                    <p class="block_contact">
                        <input type="submit" name="enviar" class="button" id="botonA" value="ENVIAR"
                            onclick="location.href='agregaPregunta.php'">
                        <input type="reset" name="cancelar" class="button" id="botonB" value="CANCELAR"
            ...
            <div class="contact-info">
                <ul>
                    <?php
                        ...
                        while ($row = $result -> fetch_assoc()) {
                        echo "<tr>";
                        echo "<u><b><td>".$row["ma_nombre"]."</td></b></u>";
                        echo "</tr>";
                        } }
						?>
                    <li>
                        <div><b>&nbsp;Acerca de Nosotros</b></div>
                        ...
                        <?php
                            ...
                            while ($row = $result -> fetch_assoc()) {
                            echo "<tr>";
                            echo "<td>".$row["ma_acerca"]."</td>";
                            echo "</tr>";
                            } }
							?>
                    </li>
                    <li>
                        <div><b>&nbsp;Teléfono Nº 1</b></div>
                        ...
                        while ($row = $result -> fetch_assoc()) {
                        echo "<tr>";
                        echo "<td>".$row["ma_telefono1"]."</td>";
                        echo "</tr>";
                        } }
                        ?>
                    </li>
                    <li>
                        <div><b>&nbsp;Teléfono Nº 2</b></div>
                    ...
                    while ($row = $result -> fetch_assoc()) {
                    echo "<tr>";
                    echo "<td'>".$row["ma_wpp"]."</td>";
                    echo "</tr>";
                    } }
					?>
                    </li>
                    <li><img src="../../config/img/logo2.png" width="400" height="300" frameborder="0" style="border:0"
                            allowfullscreen></li>
