<?php
    ...
    if($check !== false) {
    	...
    	if ($ext !== "jpg") {
    		...
    		if ($size > 64000) {
				...
				$sql = "INSERT INTO producto VALUES (0, '$ca_codigo', '$nombre', '$descripcion', '$precio', '$unidad', '$image', '$stock', '$oferta', '$azucar', '$grasa', '$sal')";
	...
	echo "<br><a href='../agregarP.php'>Regresar</a>";
	echo "<br><a href='../productos.php'>Productos</a>";
