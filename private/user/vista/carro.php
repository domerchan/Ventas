	...
	<body>
        ...
        <?php
				...
				if ($result -> num_rows == 1) {
					...
					echo "<tr>";
					echo "<td>Nombres</td>";
					echo "<td><input name='nom' value= '".$row['us_nombres']."'></td>";
					echo "</tr>";
					echo "<tr>";
					echo "<td>Apellidos</td>";
					echo "<td><input name='ape' value= '".$row['us_apellidos']."'></td>";
					echo "</tr>";
					echo "<tr>";
					echo "<td>Cédula</td>";
					echo "<td><input name='ced' value= '".$row['us_cedula']."'></td>";
					echo "</tr>";
					echo "<tr>";
					echo "<td>Dirección</td>";
					echo "<td><input name='dir' value= '".$row['us_direccion']."'></td>";
					echo "</tr>";
					echo "<tr>";
					echo "<td>Teléfono</td>";
					echo "<td><input name='tel' value= '".$row['us_telefono']."'></td>";
					echo "</tr>";
					echo "<tr>";
